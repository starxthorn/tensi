...
import { SparklesCore } from "@/components/ui/sparkles"; // Ensure this component is R3F compatible
...
import { Canvas } from "@react-three/fiber"; // Import Canvas for R3F
import { Html } from "@react-three/drei"; // Import Html for rendering HTML elements
...
export default function Page() {
  ...
  return (
    <DashboardWrapperManager>
      ...
      {/* Use SparklesCore with the Canvas wrapper */}
      <Canvas>
        <SparklesCore
        ...
        <Html>
          <section className="w-full h-full">
            <div className="flex items-center justify-between">
              ...
              <TailwindButton onClick={() => signOut()}>
                Sign Out
              </TailwindButton>
            </div>
